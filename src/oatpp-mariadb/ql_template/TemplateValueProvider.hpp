...
#ifndef oatpp_mariadb_ql_template_TemplateValueProvider_hpp
#define oatpp_mariadb_ql_template_TemplateValueProvider_hpp
...
#endif // oatpp_mariadb_ql_template_TemplateValueProvider_hpp
